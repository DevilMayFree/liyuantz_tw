  ...
  (function () {
    ...
    var init = function () {
      ...
      window.KV.platformConfig.gdpr = {
        enabled: false,
      };

      KV.gdprConsent = false;
